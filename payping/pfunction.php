					...
					if($err){
						...
						if($header['http_code'] == 200){
							...
							if(isset($_GET["refid"]) and $_GET["refid"] != ''){
								...
								* echo html tags
								*/
								echo '<div class="payment-success-notification">
								...
								<a href="https://'.$_SERVER['HTTP_HOST']. '/order-history" class="btn success">مشاهده جزئیات بیشتر</a>
								</div>';
...
//									'&payping-message=' . $payping->success($message)
//								);
							}else{
